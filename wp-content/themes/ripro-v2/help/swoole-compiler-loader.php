...
if ('web' == $env['php']['run_mode']) {
    ...
    $html_body_nav .= '<p>（RiPro-V2需要Swoole Compiler加密扩展，当前仅支持PHP7.4）<br>如果您环境是虚拟主机不支持自定义安装php扩展。<br>请去FTP或者文件管理删除 \wp-content\themes\ripro-v2\ 主题目录即可恢复网站。</p>';
    $html_body_nav .=  '</div>';
    ...
    <p style="text-align: center; font-size: 13px;">CopyRight © '. date('Y') . ' <a href="https://ritheme.com/" target="_blank" class="text-success">ritheme.com</a> ripro-v2主题加密扩展安装引导助手 如有不懂会员群交流</p>
  </footer>';

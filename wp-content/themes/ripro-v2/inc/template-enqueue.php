...
function ripro_v2_scripts() {
    ...
    $script_params = apply_filters('ripro_v2_script_params',array(
        ...
        'site_notice'      => array('is' => _cao('is_site_notify', '0'), 'color' => _cao('site_notify_color', 'rgb(33, 150, 243)'), 'html' => '<div class="notify-content"><h3><i class="fa fa-bell-o mr-2"></i>' . _cao('site_notify_title', '') . '</h3><div>' . _cao('site_notify_desc', '') . '</div></div>'),
    ));

...
function ripro_v2_add_admin_menu() {
    ...
    add_menu_page(esc_html__('商城管理', 'ripro-v2'), '商城管理', 'administrator', $index_page, $index_page, 'dashicons-cart', 100);
    $menu = [
        ['menu' => 'ripro_v2_shop_index_page', 'page' => 'shop_index', 'name' => esc_html__('商城总览', 'ripro-v2')],
        ['menu' => 'ripro_v2_pay_order_page', 'page' => 'pay_order', 'name' => esc_html__('订单总览', 'ripro-v2')],
        ['menu' => 'ripro_v2_coin_order_page', 'page' => 'pay_order', 'name' => esc_html__('充值记录', 'ripro-v2')],
        ['menu' => 'ripro_v2_down_order_page', 'page' => 'down_order', 'name' => esc_html__('下载记录', 'ripro-v2')],
        ['menu' => 'ripro_v2_aff_order_page', 'page' => 'aff_order', 'name' => esc_html__('佣金管理', 'ripro-v2')],
...
function ripro_v2_add_sticky_column($columns) {
    ...
    if ($post_type == 'post') {
        return array_merge($columns, array('cao_price' => '售价', 'cao_vip_rate' => '会员折扣'));
    } else {
        return $columns;
    }

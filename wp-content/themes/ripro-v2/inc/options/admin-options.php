...
CSF::createSection($prefix, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type'    => 'switcher',
            'title'   => '全站弹窗公告',
            'desc'   => '开启后用户首次打开网站弹出，用户下拉页面才会触发弹窗，否则不弹出，防止用户打开就弹窗，影响体验和SEO',
            'default' => true,
        ),
        array(
...
CSF::createSection($prefix, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type'    => 'switcher',
            'title'   => '动态异步加载购买按钮等付费信息',
            'label'   => '实验性功能，可以解决使用静态缓存插件不刷新问题和有效防止采集地址',
            'default' => false,
        ),
...
CSF::createSection($prefix, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type'    => 'switcher',
            'title'   => '搜索频率限制',
            'desc'    => '搜索频率限制功能比较实用，建议开启，可以有效防止恶意cc恶意搜索导致CPU负载100%网站打不开问题',
            'default' => false,
        ),
...
CSF::createSection($prefix, array(
    ...
    'fields' => array(
        ...
        array(
            'type'    => 'notice',
            'style'   => 'success',
            'content' => 'Smartideo 文章内视频插件<a target="_blank" href="'.admin_url('/plugin-install.php?s=smartideo&tab=search&type=term').'">插件地址</a><br/>Smartideo 是为 WordPress 添加对在线视频支持的一款插件（支持手机、平板等设备HTML5播放）。 目前支持优酷、搜狐视频、土豆、56、腾讯视频、新浪视频、酷6、华数、乐视、YouTube 等网站。<br/>',
        ),

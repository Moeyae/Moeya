...
if ($IS_PAID == 0) {
    ...
    if ($the_user_type == 'nov' && $the_post_price == -1) {
        ...
        $_content .= '<button type="button" class="btn btn-sm btn-dark mb-4 click-pay-post" data-postid="' . $post_id . '" data-nonce="' . $click_nonce . '" data-price="' . $the_post_price . '">' . esc_html__('立即购买', 'ripro-v2') . '</button>';
    }

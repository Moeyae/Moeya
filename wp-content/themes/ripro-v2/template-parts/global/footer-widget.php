...
<?php endif;?>
<?php if ( ( (_cao('site_footer_links_ishome',true) && is_home()) || !_cao('site_footer_links_ishome',true) ) && !empty(_cao('site_footer_links',0)) ) : 
	$bookmarks = get_bookmarks( array('orderby' => 'link_rating','category' => _cao('site_footer_links') ) );
?>
<div class="footer-links d-none d-lg-block">
	<div class="container">
		<h6><?php echo esc_html__('友情链接：','ripro-v2') ;?></h6>

    ...
    <div class="container">
	    <div class="navbar">
			...
			<div class="actions">
								...
								<div class="row no-gutters">
									...
									<div class="col-6">
										...
										<div class="menu-card-box-2"><i class="fa fa-diamond nav-icon"></i>
											...
											<p class="small m-0"><?php echo esc_html__('尊享VIP优惠特权','ripro-v2');?></p>

										</div>
										<div class="menu-card-box-3">
											<span class="small"><?php echo esc_html__('本站','ripro-v2').$site_vip['boosvip']['name'];?></span><a class="float-right badge badge-light-lighten" href="<?php echo get_user_page_url('vip');?>" rel="nofollow noopener noreferrer"><?php echo esc_html__('升级','ripro-v2');?></a>
				...
				<?php elseif ( !is_close_site_shop() && (_cao('is_site_user_login',true) || _cao('is_site_user_register',true)) ) : ?>

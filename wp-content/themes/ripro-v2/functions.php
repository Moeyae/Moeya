...
/**
 * 扩张安装帮助页面 如果使用php8.0版本 容易报502或者503错误  WP常见玄学 暂找不到原因
 */
if (extension_loaded('swoole_loader')) {
    $php_v = substr(PHP_VERSION, 0, 3);

    if ($php_v == '7.4') {
        $ripro_v2_includes[] = '/inc/class/pay.class.7.4.php';
    } elseif ($php_v == '8.0') {
        $ripro_v2_includes[] = '/inc/class/pay.class.8.0.php';
    } else {
        wp_die('<small>ripro-v2需要php7.4或者php8.0版本支持，鉴于WordPress官方推荐PHP为最新7.4版本，其他低版本php暂不支持，php7.4性能极佳，使用ripro-v2性能更佳，如您的PHP环境没有7.4版本，请去FTP或者文件管理删除 \wp-content\themes\ripro-v2\ 主题目录即可恢复网站。</small>', 'php版本过低提示');exit;
    }

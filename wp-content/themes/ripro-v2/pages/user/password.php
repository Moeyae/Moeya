...
<div class="card mb-2 mb-lg-4">
    <div class="card-header">
        <h5 class="card-title"><?php echo esc_html__('账号密码管理','ripro-v2');?></h5>
    </div>
    <!-- Body -->
    <div class="card-body">
        <form>
        	...
        	<div class="row form-group">
                <label class="col-sm-3 col-form-label input-label"><?php echo esc_html__('旧密码','ripro-v2');?></label>
                <div class="col-sm-9">
            ...
            <div class="row form-group">
                <label class="col-sm-3 col-form-label input-label"><?php echo esc_html__('新密码','ripro-v2');?></label>
                <div class="col-sm-9">
            ...
            <div class="row form-group">
                <label class="col-sm-3 col-form-label input-label"><?php echo esc_html__('确认新密码','ripro-v2');?></label>
                <div class="col-sm-9">
                    <div class="input-group">
                      <input type="password" class="form-control" name="new_password2">
                      <div class="input-group-append">
                        <button id="update-password" class="btn btn-sm btn-primary" data-nonce="<?php echo $_nonce; ?>" type="button"><?php echo esc_html__('确认修改密码','ripro-v2');?></button>
                      </div>
                    </div>
                </div>
            </div>

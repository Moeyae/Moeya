...
<?php if ( _cao('is_site_register_bind_email') && empty($current_user->user_email) ) : ?>
    <div class="alert alert-warning alert-dismissible fade show" role="alert">
      <strong><?php echo esc_html__('账号绑定提示！','ripro-v2');?></strong> <?php echo esc_html__('为了您的账号安全，请在下方绑定您的邮箱账号','ripro-v2');?>
...
<div class="card mb-2 mb-lg-4">
    <div class="card-header">
        <h5 class="card-title"><?php echo esc_html__('账号邮箱绑定','ripro-v2');?></h5>
    </div>
    <!-- Body -->
    <div class="card-body">
        <form>
            <div class="row form-group">
                <label class="col-sm-3 col-form-label input-label"><?php echo esc_html__('当前绑定邮箱','ripro-v2');?></label>
                <div class="col-sm-9">
            ...
            <div class="row form-group">
                <label class="col-sm-3 col-form-label input-label"><?php echo esc_html__('安全验证','ripro-v2');?></label>
                <div class="col-sm-9">
            ...
            <?php if (_cao('is_site_email_captcha_verify')):?>
                <div class="row form-group">
                    <label class="col-sm-3 col-form-label input-label"><?php echo esc_html__('绑定新邮箱','ripro-v2');?></label>
                    <div class="col-sm-9">
                        <div class="input-group">
                          <input type="email" class="form-control pl-3" placeholder="输入要新邮箱账号" name="user_email">
                          <div class="input-group-append">
                            <button class="btn btn-sm btn-outline-secondary go-send-email-code" type="button" id="send-email-code"><?php echo esc_html__('发送验证码','ripro-v2');?></button>
                          </div>
                        </div>
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-sm-3 col-form-label input-label"><?php echo esc_html__('邮箱验证码','ripro-v2');?></label>
                    <div class="col-sm-9">
                        <div class="input-group">
                          ...
                          <div class="input-group-append">
                            <button class="btn btn-sm btn-primary go-bind-email" type="button" id="bind-email-code"><?php echo esc_html__('绑定新邮箱','ripro-v2');?></button>
                          </div>
                        </div>
                    </div>
                </div>
...
<div class="card mb-3 mb-lg-5">
    <div class="card-header">
        <h5 class="card-title"><?php echo esc_html__('第三方登录绑定','ripro-v2');?></h5>
    </div>
    <!-- Body -->
    <div class="card-body">
        <p class="card-text"><?php echo esc_html__('绑定第三方登录您可以快速登录账号','ripro-v2');?></p>
        <form>

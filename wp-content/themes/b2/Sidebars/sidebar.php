            ...
            <section class="widget b2-widget-hot mg-b box b2-radius">
                <ul class="b2-widget-box">
                    ...
                    <li>
                        ...
                        <p><?php echo __('您可以通过在本站发布收费内容、发布商品等方式获得收益，用户给您的打赏也将进入到您的余额之中','b2'); ?></p>
                    </li>
                </ul>
            </section>
        </div>
            ...
            <section class="widget mg-b box b2-radius">
                <ul class="b2-widget-box">
                    ...
                    <li>
                        ...
                        <p><?php echo sprintf(__('2、1元人民币兑换%s积分'),b2_get_option('normal_gold','credit_dh')); ?></p>
                    </li>
                    <li>
...
<?php if($pagename === 'all-circles'){ ?>
    <aside id="secondary" class="widget-area custom-page-widget">
        <div id="sidebar-innter">
            <section class="widget mg-b box b2-radius">
                <ul class="b2-widget-box">
                    <li>
                        <p><b><?php echo __('如何创建圈子？','b2'); ?></b></p>
                        <p><?php echo __('1、您有时间管理圈子；','b2'); ?></p>
                        <p><?php echo __('2、对您创建的圈子内容有一定的专业性；','b2'); ?></p>
                        <p><?php echo __('3、拥有本站创建圈子的权限；','b2'); ?></p>
                    </li>
                </ul>
                <div class="circle-widget-button"> <button class="text" onclick="postPoBox.go('<?php echo home_url().'/create-circle'; ?>','create_circle')"><?php echo __('创建圈子','b2'); ?></button></div>
            </section>
        </div>
    </aside>
<?php } ?>
        ...
        <div id="sidebar-innter">
            <section class="widget mg-b box b2-radius">
                <ul class="b2-widget-box">
                    ...
                    <li>
                        <p><b><?php echo __('如何获得收益？','b2'); ?></b></p>
                        <p><?php echo __('您的伙伴消费后，您将获得相应比例的推广提成，进入到您的余额中','b2'); ?></p>
                    </li>
                    <li>
                        <p><b><?php echo __('如何提现','b2'); ?></b></p>
                        <p><?php echo __('财富中心有您的余额记录，详细记录了每笔收付账单，您可以在财富中心进行提现操作','b2'); ?></p>
                    </li>
                </ul>
            </section>
        </div>

...
<div id="author-index">
    <div class="user-info box b2-radius mg-b">
        ...
        <p class="b2-pd">
            ...
            <span v-show="userData.self || userData.admin" v-cloak><?php echo sprintf(__('本站第%s号会员'),'<b v-text="userData.id"></b>'); ?></span> <?php echo sprintf(__('入驻本站%s天','b2'),'<b>'.b2_time_days($user_data->user_registered).'</b>'); ?>
        </p>
        <p class="b2-pd">
    ...
    <ul class="user-sidebar-count box b2-radius">
        ...
        <li>
            ...
            <div>
                <div class="user-item-name"><?php echo __('发布的快讯','b2'); ?></div>
                <p class="user-item-count"><?php echo count_user_posts($user_id, 'newsflashes' ); ?></p>
                <div class="user-item-desc"><?php echo __('在本站发布的快讯','b2'); ?></div>
                <a href=""></a>
            </div>
        </li>
        <?php } ?>
        ...
        <li>
            <?php echo b2_get_icon('b2-flashlight-line'); ?>
            <div>
                <div class="user-item-name"><?php echo __('收藏的快讯','b2'); ?></div>
                <p class="user-item-count"><?php echo User::get_user_collection_count($user_id,'newsflashes'); ?></p>
                <div class="user-item-desc"><?php echo __('收藏的快讯数量','b2'); ?></div>
                <a href=""></a>
            </div>
        </li>
        <?php } ?>

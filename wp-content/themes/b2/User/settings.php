<div class="author-edit-page box b2-radius" id="author-edit-page" ref="authorEdit">
    ...
    <ul class="author-edit-list">
        ...
        <li>
            ...
            <div class="edit-item">
                <div class="edit-value" v-if="!show.desc"><span v-text="userData.desc ? userData.desc : '<?php echo __('这人很懒什么都没留下','b2'); ?>'"></span><span class="user-edit-button" @click="show.desc = true"><?php echo b2_get_icon('b2-edit-2-line').__('编辑','b2'); ?></span></div>
                <div class="edit-input" v-else v-cloak>
                    ...
                    <ul v-if="userData.default_address">
                        <li>
                            <div class="user-address-info address-default">    
                                <span v-text="userData.address[userData.default_address].address"></span>

...
<div id="author-newsflashes" ref="authornewsflasheslist" data-paged="<?php echo $paged; ?>">
    ...
    <div class="author-page-nav box b2-radius b2-pd mg-t" ref="AuthorSettings" v-show="list !== '' && pages > 0" v-cloak>
        <page-nav ref="commentPageNav" paged="<?php echo $paged; ?>" navtype="json" :pages="pages" type="p" :box="selecter" :opt="options" :api="api" url="<?php echo get_author_posts_url($user_id).'/newsflashes'; ?>" title="" @return="get"></page-nav>
    </div>
</div>
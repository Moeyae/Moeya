            ...
            <div class="news-content" ref="paged" data-paged="<?php echo $paged; ?>">
                ...
                <div id="post-news" :class="['modal',showPostFrom ? 'show-modal' : '']" v-cloak>
                    <div class="modal-content">
                        ...
                        <div class="post-news b2-radius mg-b b2-pd">
                            ...
                            <div class="news-des">
                                <textarea class="news-des-textarea" ref="newsTextarea" v-model="data.content" placeholder="<?php echo __('快讯内容','b2'); ?>"></textarea>
                ...
                <div class="box b2-radius newsflashes-list">
                    <div class="newsflahses-cover" style="background-image:url(<?php echo b2_get_thumb(array('thumb'=>b2_get_option('newsflashes_main','newsflashes_cover'),'width'=>800,'height'=>200)); ?>)">
                        <div class="n-desc">
                            <div class="n-desc-name">
                                <h1><?php echo b2_get_option('newsflashes_main','newsflashes_name'); ?></h1>
                                        ...
                                        <div class="news-item-content">
                                            <div class="news-item-h">
                                                <div>
                                                    ...
                                                    <div>
                                                        <p class="b2-hover"><span v-html="_item['content']"></span><a :href="_item['from']" target="_blank" rel="nofollow" v-if="_item['from']" class="item-from"><?php echo b2_get_icon('b2-external-link-line').__('原文连接','b2'); ?></a></p>
                                                    </div>
                                                </div>
                    ...
                    <div class="b2-pagenav <?php echo $data['pages'] <= 1 ? 'b2-hidden-always' : ''; ?> " data-max="<?php echo $data['pages']; ?>">
                        <page-nav ref="goldNav" paged="<?php echo $paged; ?>" navtype="json" pages="<?php echo $data['pages']; ?>" type="m" :box="selecter" :opt="opt" :api="api" url="<?php echo get_post_type_archive_link('newsflashes').(isset($_GET['action']) ? '?action=showbox' : ''); ?>" title="<?php echo $name; ?>" @return="get"></page-nav>
                    </div>
                </div>
            </div>
        </main>

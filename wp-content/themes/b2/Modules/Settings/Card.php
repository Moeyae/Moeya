...
class Card{
    ...
    public function list_option_page_cb($cmb_options){
        ...
        <div class="wrap cmb2-options-page option-<?php echo $cmb_options->option_key; ?>">
            ...
            <div class="wrap">
                <ul class="subsubsub">
                    <li class="all"><a href="<?php echo home_url('/wp-admin/admin.php?page=b2_card_list&card_status=all'); ?>" class="<?php echo $status === 'all' ? 'current' : ''; ?>"><?php echo __('所有','b2'); ?><span class="count">（<?php echo $card_code->get_status_count('all'); ?>）</span></a> |</li>
                    <li class="mine"><a href="<?php echo home_url('/wp-admin/admin.php?page=b2_card_list&card_status=0'); ?>" class="<?php echo $status === '0' ? 'current' : ''; ?>"><?php echo __('未使用','b2'); ?><span class="count">（<?php echo $card_code->get_status_count(0); ?>）</span></a> |</li>
                    <li class="publish"><a href="<?php echo home_url('/wp-admin/admin.php?page=b2_card_list&card_status=1'); ?>" class="<?php echo $status === '1' ? 'current' : ''; ?>"><?php echo __('使用','b2'); ?><span class="count">（<?php echo $card_code->get_status_count(1); ?>）</span></a></li>
                </ul>

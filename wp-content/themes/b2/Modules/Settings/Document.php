...
class Document{
    ...
    public function document_settings(){
        ...
        $document = new_cmb2_box( array(
            ...
            'tab_title'    => __('文档首页','b2'),
            'menu_title'   => __('文档设置','b2'),
        ...
        $document->add_field(array(
            'name'    => __( '要显示的文档名称', 'b2' ),
            'id'=>'document_name',
            'desc'=>__('给文档起个名字，比如帮助中心、XXwiki等。','b2'),
            'type'=>'text',
            'default'=>self::get_default_settings('document_name')
        ));

        $document->add_field(array(
            'name'    => __( '文档首页SEO描述', 'b2' ),

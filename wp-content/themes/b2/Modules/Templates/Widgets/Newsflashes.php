	...
	public function __construct() {
		parent::__construct(
			...
			array(
				...
				'description' => __( '一个页面最多只能有一个快讯小工具！显示热门快讯，最新快讯，利好最多快讯等', 'b2' ),
			)
		);
		...
		$this->cmb2_fields = array(
			...
			array(
				'name'    => __('快讯标签ID','b2'),
				'desc'    => sprintf(__('可以填写快讯标签ID，多个请用竖线|隔开。ID之间是或者的关系，比如设置ID为1的标签和ID为12的分类，写作%s，这里将会显示标签是1，或者分类是12的文章。留空将显示全部。','b2'),'<code>1|12</code>'),
				'id_key'  => 'news_tag',
				'id'      => 'news_tag',
				'type'    => 'textarea_small'
			),
	...
	public static function get_widget( $atts ) {
        ...
        $html = '
            <div class="widget-newsflashes-box" ref="newsWidget" data-json=\''.json_encode($args).'\'>
				...
				<div class="widget-mission-footer"><a href="'.get_post_type_archive_link('newsflashes').'" target="_blank">'.__('全部快讯','b2').'</a></div>
            </div>
        ';

...
class User extends \WP_Widget{
	...
	public function __construct() {
		...
		//默认设置项
		self::$defaults = array(
			'user_no_login_text'=>__('所有的伟大，都源于一个勇敢的开始'),
			'show_mobile'=>0
		);
		...
		$html = '
			<div class="user-widget" id="user-widget" ref="userWidget">
				<div class="user-widget-content">
					...
					<div v-show="announcement != \'\'" v-cloak>
						...
						<div v-if="!b2token" v-cloak>
							<div class="user-w-logon">
								<p class="user-w-logon-title b2-color">'.__('嗨！朋友').'</p>
							...
							<div v-if="announcement != \'\' && announcement != \'none\'">
								<ul>
									<li v-for="item in announcement">
										<a :href="item.href" target="_blank"><b>'.__('公告：','b2').'</b><span v-text="item.title"></span></a>
									</li>
								</ul>
							</div>
					...
					<div class="widget-mission-footer"><a href="'.b2_get_custom_page_url('announcements').'" target="_blank">'.__('全部公告','b2').'</a></div>
				</div>
			</div>

...
class CircleInfo extends \WP_Widget{
	...
	public function __construct() {
		...
		self::$defaults = array(
			...
			'circle_info_title'=>__('创建自己的圈子','b2'),
			'show_mobile'=>0
		);
		...
		$html = '
			<div class="about-widget">
				...
				<div class="circle-widget-button">
					<button class="text" onclick="postPoBox.go(\''.b2_get_custom_page_url('create-circle').'\',\'create_circle\')">'.__('创建圈子','b2').'</button>
				</div>
			</div>
		';

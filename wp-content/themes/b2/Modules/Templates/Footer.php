                ...
                <div class="bar-middle" v-cloak>
                    ...
                    <?php if($aside_vip && !$audit){ ?>
                        <div class="gdd-quick-link-buy-vip">
                            <a target="_blank" href="<?php echo home_url('/vips'); ?>">
                            ...
                            <div class="gdd-quick-link-buy-vip__popover">
                                <div>
                                    ...
                                    <a target="_blank" href="<?php echo home_url('/vips'); ?>"><p class="gdd-quick-link-buy-vip__popover--btn"><?php echo __('立刻开通','b2'); ?></p></a>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
                    ...
                    <template v-if="b2token">
                        ...
                        <div class="bar-user-info-row">
                            ...
                            <div class="user-w-gold">
                                <div class="user-money"><a href="<?php echo b2_get_custom_page_url('gold'); ?>"><span><?php echo B2_MONEY_SYMBOL; ?></span><b><?php echo __('余额：'); ?>{{userData.money}}</b></a></div>
                                <div class="user-credit"><a href="<?php echo b2_get_custom_page_url('gold'); ?>"><span><?php echo b2_get_icon('b2-coin-line'); ?></span><b><?php echo __('积分：'); ?>{{userData.credit}}</b></a></div>
                            </div>
                        </div>
                    </template>
                </div>

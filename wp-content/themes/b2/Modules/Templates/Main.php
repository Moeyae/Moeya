...
class Main{
    ...
    public function custom_name($data){
        ...
        $data['document'] = b2_get_option('document_main','document_name');
        $data['newsflashes'] = b2_get_option('newsflashes_main','newsflashes_name');
        $data['circle'] = b2_get_option('circle_main','circle_name');
    ...
    public function setup_frontend_scripts(){
        ...
        //加载字体
        wp_enqueue_style( 'b2-fonts', '//at.alicdn.com/t/font_2579934_ownzldy583.css' , array() , B2_VERSION , 'all');
        ...
        //message
        wp_enqueue_script( 'timeago', B2_THEME_URI.'/Assets/fontend/library/message.min.js', array(), B2_VERSION , true );
        ...
        .topic-drop-box{
            border-top:1px solid rgba('.$rgb[0].', '.$rgb[1].', '.$rgb[2].', 0.14);
        }
    ...
    public static function sidebar_css(){
        ...
        // if(self::show_sidebar()){
            $css .= '.widget-area{
                width:'.$width.'px;
                min-width:'.$width.'px;
                padding-left:'.B2_SIDEBAR_GAP.'px;
                max-width:100%;
            }

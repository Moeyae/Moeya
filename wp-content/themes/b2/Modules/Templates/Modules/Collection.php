                        ...
                        <div>
                            <div class="home-collection-in b2-radius box">
                                <div class="home-collection-image">
                                    <div>
                                    '.($qishu ? '<span class="collection-number ar b2-color b2-radius">'.sprintf(__('专题：第%s期','b2'),$qishu).'</span>' : '').'
        ...
        foreach ($collection_data as $k => $v) {
            ...
            <div class="collection-item">
                <div class="box b2-radius">
                    ...
                    <span>'.sprintf(__('专题：第%s%s%s期','b2'),'<b>',$qishu,'</b>').'</span>
                </div>' : '').'
    ...
    public static function get_data($data){
        ...
        foreach ($terms as $k => $v) {
            ...
            $arr[] = array(
                ...
                'thumb'=>$thumb,
                'name'=>$v->name,
                'posts'=>Coll::get_collection_post_list($v->term_id,$data['collection_count']),

	...
	*/ 
    ...
    public static function sendCurlPost($url, $dataObj){
     ...
     public static function others($phone,$code){
        $resout = wp_remote_post(str_replace(array('#phone#','#code#'),array($phone,$code),b2_get_option('normal_login','others_url')));
     ...
     public static function aliyun($mobile, $verify_code) {
         ...
         if (isset ( $result ['Code'] ) && $result ['Code'] === 'OK') {
             ...
             return array('error'=>self::getErrorMessage( $result ['Code'] ));
         }
     }
     /**
      * 获取详细错误信息

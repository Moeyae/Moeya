...
<article class="single-article b2-radius box">
        ...
        <div id="post-meta">
            <ul class="post-meta">
                ...
                <li class="single-date">
                    <span><?php echo $data['date']['date']; ?></span>
                </li>
                <li class="single-eye">
    ...
    <div class="entry-content">
        ...
        <?php 
            if($data['from']){
                echo '<p class="b2-hover"><a class="news-from" href="'.$data['from'].'" target="_blank">'.b2_get_icon('b2-external-link-line').__('原文连接','b2').'</a></p>';
            }
        ?>

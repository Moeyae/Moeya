...
<div class="shop-normal-item" data-id="<?php echo $post_id; ?>">
    <div class="shop-normal-item-in box b2-radius">
        <div class="shop-normal-item-img">
            <template v-if="data == ''">
                <img src="<?php echo B2_THEME_URI; ?>/Assets/fontend/images/default-img.jpg" />
            </template>
        ...
        <div class="shop-normal-item-info shop-exchange-item-info">
                ...
                <div class="shop-normal-item-left">
                    <div class="shop-item-price-credit">
                        <span :class="data != '' && data[<?php echo $post_id; ?>].price.price ? 'shop-item-delete' : ''" v-cloak>
                            <?php echo __('原价：'); ?><i><?php echo B2_MONEY_SYMBOL; ?></i>
            ...
            <div class="shop-normal-item-count">
                <span><?php echo __('库存：'); ?><b v-if="data === ''">--</b><b v-else v-text="data[<?php echo $post_id; ?>].stock.total"></b></span>
                <span v-show="data !== '' && data[<?php echo $post_id; ?>].stock.sell !== ''" v-cloak><?php echo __('抽中：'); ?><b v-if="data === ''">--</b><b v-else v-text="data[<?php echo $post_id; ?>].stock.sell"></b></span>
                <span><?php echo __('人气：'); ?><b v-if="data === ''">--</b><b v-else v-text="data[<?php echo $post_id; ?>].views"></b></span>
            </div>
        </div>
    </div>
</div>
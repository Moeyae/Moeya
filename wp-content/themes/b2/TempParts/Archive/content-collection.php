...
<div class="box b2-radius">
    <div class="collection-list-top">
        ...
        <div class="collection-list-top-info">
            ...
            <div class="read-more mg-t">
                <a href="<?php echo b2_get_custom_page_url('collection'); ?>" target="_blank"><?php echo __('往期专题','b2').b2_get_icon('b2-arrow-right-s-line'); ?></a>
            </div>
        </div>
    </div>
    ...
    <div class="archive-row">
        ...
        <div class="collection-header b2-padding">
            <div class="">
                <?php echo sprintf(__('一共%s%s%s篇文章','b2'),'<b class="b2-color">',$data['count'],'</b>');?>
            </div>
            <div class="collection-number b2-radius">
                <span><?php echo sprintf(__('专题：第%s%s%s期','b2'),'<b>',$index,'</b>'); ?></span>
            </div>
        </div>

                    ...
                    <div class="topic-comment-content">
                        ...
                        <div class="topic-author-meta">
                            ...
                            <div class="topic-author-meta-right">
                                <button :class="['text',{'b2-color':commentBox.parent == list.comment_ID}]" @click="showChildComment(ci,list.comment_ID)"><?php echo b2_get_icon('b2-chat-smile-2-line'); ?><b v-text="list.child_comments.list.length"></b></button>

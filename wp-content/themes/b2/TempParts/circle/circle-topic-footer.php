    ...
    <div class="topic-footer-left">
        ...
        <div class="topic-meta-more-box">
            ...
            <div class="topic-more-menu">
                <ul>
                    <li v-if="isAdmin() || item.role.can_delete"><a :href="'<?php echo home_url('/circle-topic-edit?topic_id='); ?>'+item.topic_id" target="_blank"><?php echo __('编辑话题','b2'); ?></a></li>
                    <li v-if="isAdmin() || item.role.can_delete"><button @click="deleteTopic(ti,item.topic_id)"><?php echo __('删除话题','b2'); ?></button></li>
                    <li><button class="fuzhi" :data-clipboard-text="item.link"><?php echo __('复制连接','b2'); ?></button></li>

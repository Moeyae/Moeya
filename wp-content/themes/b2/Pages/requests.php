...
<div class="b2-document-single mg-t- mg-b">
    <div class="document-single-top wrapper">
        ...
        <form method="get" action="<?php echo home_url('/document'); ?>" class="single-document-search">
...
<div class="b2-single-content wrapper">
    <div id="requests-page" class="content-area wrapper request-page" ref="requests">
                ...
                <div v-else-if="requestList.length > 0" v-cloak class="request-list-box">
                    <ul>
                        <li v-for="item in requestList" @click="showDrap(item.id)" :class="'b2-pd '+item.type">
                            ...
                            <div class="request-title" v-else><?php echo b2_get_icon('b2-whatsapp-line'); ?><span><?php echo __('客服回复：'); ?></span></div>

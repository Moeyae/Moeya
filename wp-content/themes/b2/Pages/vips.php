                        ...
                        <div class="vip-row">
                            <ul>
                                <li :class="['vip-allow',{'allow':item.allow_read === '1'}]">
                                    <span v-if="item.allow_read === '1'"><?php echo b2_get_icon('b2-checkbox-circle-fill'); ?></span>
                                    <span v-else><?php echo b2_get_icon('b2-close-circle-fill'); ?></span>
                                    <?php echo __('查看所有隐藏内容','b2'); ?></li>
                                <li :class="['vip-allow',{'allow':item.allow_download === '1'}]">
                                    <div v-if="item.allow_download === '1'"><?php echo b2_get_icon('b2-checkbox-circle-fill'); ?><?php echo __('免费下载资源','b2'); ?><span>{{item.allow_download_count}}<?php echo __('次/天','b2'); ?></span></div>
                                    <div v-else><?php echo b2_get_icon('b2-close-circle-fill'); ?><?php echo __('免费下载资源','b2'); ?></div>
                                </li>
                                <li :class="['vip-allow',{'allow':item.allow_videos === '1'}]">
                                    <div v-if="item.allow_videos === '1'"><?php echo b2_get_icon('b2-checkbox-circle-fill'); ?><?php echo __('免费查看所有付费视频','b2'); ?></div>
                                    <div v-else><?php echo b2_get_icon('b2-close-circle-fill'); ?><?php echo __('免费查看所有付费视频','b2'); ?></div>
                                </li>
                                <li v-for="role in item.user_role" :class="['vip-allow',{'allow':role.allow}]">
                                    <span v-if="role.allow"><?php echo b2_get_icon('b2-checkbox-circle-fill'); ?></span>
                                    <span v-else><?php echo b2_get_icon('b2-close-circle-fill'); ?></span>
                                    <span>{{role.name}}</span>
                                </li>
                                <li class="vip-allow allow">
                                    <?php echo b2_get_icon('b2-checkbox-circle-fill'); ?><?php echo __('享受专属打折商品','b2'); ?>
                                </li>
                                <li class="vip-allow allow more">
                                    <?php echo __('更多...','b2'); ?>
                                </li>
                            </ul>
                        </div>

                        ...
                        <div class="mission-tk">
                            ...
                            <ol>
                                ...
                                <li v-if="mission.data.mission.current_user">
                                    ...
                                    <span v-else>
                                        <?php echo sprintf(__('您目前已经有%s天未签到，填坑倍数为%s，填坑需要支付%s积分，您当前的积分为%s。'),'{{mission.data.mission.tk.days}}','{{mission.data.mission.tk.bs}}','{{mission.data.mission.tk.credit}}','{{mission.data.mission.my_credit}}'); ?>
                                    </span>
                                </li>
                            </ol>
                        </div>

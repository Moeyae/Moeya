                        ...
                        <div :class="item.role">
                            <div>
                                ...
                                <div class="circle-users-info">
                                    <h2><a :href="item.user_data.link" target="_blank"><span v-text="item.user_data.name"></span><b v-if="item.is_circle_admin" class="circle-admin-mark"><?php echo __('圈主','b2'); ?></b></a></h2>
                            ...
                            <p class="circle-users-date"><span v-if="item.role == 'pending'"><?php echo __('申请时间：','b2'); ?></span><span v-else><?php echo __('加入时间：'); ?></span><span v-text="item.date"></span></p>
                        </div>
                    </li>
                </ul>
            </div>

...
$type = isset($_GET['type']) && !empty($_GET['type']) ? $_GET['type'] : 'post';
...
<div class="tax-search box wrapper b2-radius mg-b">
    ...
    <form method="get" action="<?php echo $url.$request; ?>" autocomplete="off">
        <input type="text" name="s" class="b2-radius" placeholder="<?php echo sprintf(__('在「%s」中搜索','b2'),$post_type[$type]);?>" value="<?php echo $key; ?>">
